...
// import { RagResource, Retrieval, VertexRagStore, To } from '@google-cloud/vertexai';
...
export default function BioChatWindow({ setCurrentWindow }) {
    ...
    const getResponseForGivenPrompt = async () => {
        try {
            setLoading(true);
            // Create the corpus (your collection of documents)
            const corpus = await createCorpus();
            console.log("Corpus created:", corpus);

            // Create a RAG resource using the corpus name.
            const ragResource = {
                ragCorpus: "projects/417452680909/locations/us-central1/ragCorpora/7631349568579305472"
            };

            // Define the retrieval tool.
            // Here we mimic the structure from the Python code.
            const ragRetrievalTool = {
                type: "retrieval",
                retrieval: {
                    source: {
                        type: "vertex_rag_store",
                        ragResources: [ragResource], // Only one corpus is allowed.
                        similarityTopK: 10
                    }
                }
            };
