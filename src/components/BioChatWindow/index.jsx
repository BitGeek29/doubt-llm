  ...
  const getResponseForGivenPrompt = async () => {
    try {
      ...
      const response = await fetch(
        'https://discoveryengine.googleapis.com/v1alpha/projects/417452680909/locations/global/collections/default_collection/engines/ncert_notes/servingConfigs/default_search:answer',
        {
          method: 'POST',
          headers: {
          ...
          body: JSON.stringify({
            ...
            answerGenerationSpec: {
              ...
              promptSpec: {
                preamble: `You are a tutor specializing in NCERT Biology for Class 11 and 12.
                              ...
                              \n3. Solution referred book and its page number as per the given solution.
              ...
              modelSpec: { modelVersion: "gemini-1.5-flash-001/answer_gen/v1" }
            }
          })
        }
      );
